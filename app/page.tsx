...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex flex-col flex-1 px-4 sm:px-6 lg:px-8 py-6">
        {/* Controls */}
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 flex-1 min-h-0">
            {/* Map column */}
            <div className="flex flex-col min-h-75 lg:min-h-0 rounded-xl border border-gray-200 overflow-hidden">
